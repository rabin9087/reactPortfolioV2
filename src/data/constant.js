...
export const experiences = [
  {
    ...
    desc: [
      "Developed server-side web applications using Node.js and Express, ensuring seamless integration with frontend technologies",
      ...
      "Rigorously tested API endpoints with Postman, ensuring functionality, performance, and security",
      "Managed version control using Git, facilitating collaborative development and codebase maintenance",
      "Created RESTful APIs and microservices for seamless integration with other applications",
      "Developed a secure authentication system that ensure user privacy and data security",
      "Collaborated with cross-functional teams, including frontend developers and product managers, designers to ensure cohesive and efficient application development",
      "Implemented a responsive design for use on various devices, maintaining consistent user experience",
      "Optimized database queries to improve application performance and reduce response times by 15%",
      "Integrated Stripe for a third-party secure payment system",
      "Translated requirements into well-structured, maintainable, and well-documented code",
      "Debugged applications using Chrome inspector",
      "Implemented and maintained automated tests using Playwright to ensure the reliability and performance of the platform",
    ],
    skills: [
      "HTML",
      "CSS",
  ...
  },
  {
    ...
    desc: [
      "Developed and maintained React applications using HTML5, CSS3, TypeScript, React.js, Redux, and Tailwind.",
      "Used Git as a version control system to manage and track changes in the codebase",
      "Designed and developed a RESTful APIs for the frontend using React and Axios to facilitate effective communication with backend services, enhancing system interoperability",
      "Collaborated with back-end developers to integrate frontend components with server-side logic and APIs",
      ...
      "Debugged and fixed bugs to ensure optimal performance and functionality of web applications",
      "Ensured the platform is user-friendly, responsive, and accessible, creating a seamless experience for users"],
    skills: [
      "HTML5",
      "CSS3",
      "JavaScript",
