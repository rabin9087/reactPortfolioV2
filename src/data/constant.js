...
export const Bio = {
  ...
  description: "a motivated, energetic, and enthusiastic graduate seeking a software developer role. I can use my programming skills, ability to understand complex business functionality, problem-solving skills, and teamwork expertise to improve performance and accelerate digital transformation in the resources sector.",
...
export const experiences = [
  {
    ...
    desc: ["Performed coding, debugging, and unit testing tasks in support of projects",
      ...
      "Developed scalable web-based user interfaces and components using ReactJs and Bootstrap",
      ...
      "Improved the application performance by 20% by optimizing the back-end code",
      ...
      "Created an API gateway that improved system performance by 12% and reduced latency by 9%"],
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
